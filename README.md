...
>Note: This Managed Application can be deploy into a Service Catalog.
For Marketplace, please see these instructions: [**Marketplace Managed Application**](https://docs.microsoft.com/en-us/azure/managed-applications/publish-marketplace-app)

## Deploy the content of the managed application
...
## Deploy this to your Service Catalog
